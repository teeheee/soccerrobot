beware of unreadable code..


This Project only builds with make under linux

To use it you have to install the arm-non-eabi cross compiler and modify the makefile for your needs.
You probably have to recompile the teensy_loader_cli for your workstation too....
The codeblocks project uses the pre configured makefile so don't bother opening it. just make a new one.


the next section is from the orginal template
